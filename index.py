...
if uploaded_file:    
    ...
    sns.barplot(x='support_percentage', y='itemsets', data=frequent_itemsets, palette='viridis')  
    plt.title('Frequent Itemsets Support Percentage')  
    ...
    if not frequent_itemsets.empty:    
        ...
        plt.figure(figsize=(10, 6))  
        sns.scatterplot(data=rules, x='support', y='confidence_percentage', hue='lift', size='lift', sizes=(20, 200), palette='viridis', legend='full')  
        ...
        st.warning("Tidak ada frequent itemsets yang ditemukan.")    
